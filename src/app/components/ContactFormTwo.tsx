      ...
      {isClient && (
        ...
        >
          <motion.div
            ...
            className="md:w-1/2"
          >
            <h2 className="text-xl font-semibold text-[#6c9b16]  mb-4">
          ...
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 1 }}
            className="md:w-1/2 bg-primary opacity-95 p-2 md:p-8 rounded-xl shadow-lg w-full"
          >
            ...
            <form onSubmit={handleSubmit} className="grid gap-6">
              {["firstName", "email", "phone", "date"].map((name) => (
                <div key={name}>
                  <input
                    ...
                    className="p-2 border rounded-lg w-full text-lg focus:ring-2 focus:ring-green-500"
                  />
                  {errors[name] && (
              ...
              <textarea
                ...
                onChange={handleChange}
                className="p-4 border rounded-lg h-16 w-full text-lg focus:ring-2 focus:ring-green-500"
              ></textarea>
              <button
                type="submit"
