...
export default function WhyBloodCleanse() {
  return (
    <div className="max-w-4xl mx-auto py-6 md:py-16">
      <div>
        ...
        <p className="text-gray-700 text-justify">
          ...
          overall well-being. The bloodstream acts as a transportation network,
          delivering essential nutrients, oxygen, and hormones to cells
          throughout the body. At the same time, it carries away waste
