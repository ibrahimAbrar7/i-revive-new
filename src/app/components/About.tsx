        ...
        <div className="md:col-span-4">
          ...
          <div className={`${showFullContent ? "" : "line-clamp-6"}`}>
            <p className="text-gray-500 mb-4 text-justify">
              ...
              , we offer professional Hijama (cupping therapy) for both women
              and men, designed to restore health, balance, and overall
              well-being. Whether you’re struggling with back pain, neck
              stiffness, migraines, fatigue, or chronic conditions like
              diabetes, hormonal imbalances, or high blood pressure, our
              certified Hijama specialists are here to support your healing
              journey.
            </p>

            <p className="text-gray-500 mb-4 text-justify">
              We also provide Hijama for females by experienced female
              therapists, ensuring complete privacy, comfort, and personal care
              in a safe environment. Our therapy works by removing toxins,
              improving blood circulation, and stimulating the body’s natural
              ability to heal itself—gently and effectively.
            </p>

            <p className="text-gray-500 text-justify">
              At i-Revive, we believe in real results and have helped many
              clients experience relief and transformation through regular
              sessions. If you&apos;re looking for the best Hijama center in
              Hyderabad or a ladies-only Hijama center near you, we’re here for
              you.
            </p>
          </div>
