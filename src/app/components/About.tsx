        ...
        <div className="md:col-span-4">
          ...
          <div className={`${showFullContent ? "" : "line-clamp-6"}`}>
            <p className="text-gray-500 mb-4 text-justify">
              At i-Revive Hijama Center in Hyderabad, we offer professional
              Hijama (cupping therapy) for both women and men, designed to
              restore health, balance, and overall well-being. Whether you’re
              struggling with back pain, neck stiffness, migraines, fatigue, or
              chronic conditions like diabetes, hormonal imbalances, or high
              blood pressure, our certified Hijama specialists are here to
